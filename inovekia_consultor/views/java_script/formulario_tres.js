$(document).ready(function(){
	...
	$("#btn-enviar").click(function(){
		if(validarFormulario("formulariotres")){
			var datos = new FormData(document.getElementById("formulariotres"));
			...
			$.ajax({
				...
				type: "POST",
				url: "../../ajax.php?c=formulario_tres&f=guardarFormularioTres",
				data: datos,
				dataType: "json",
				processData: false,
			  	contentType: false,
