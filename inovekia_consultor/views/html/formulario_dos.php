...
<body>
				                ...
				                <div class="row">
					            	<div class="col-sm-6 col-md-6">
						               ...
						               <div class="input-group date">
		                					<input type="text" class="form-control requerido" id="f2p1a" name="f2p1a"/>
						            ...
						            <div class="col-sm-6 col-md-6">
						               <label>FIN</label>
						               <div class="input-group date">
		                					<input type="text" class="form-control requerido" id="f2p1b" name="f2p1b"/>
		            						<span class="input-group-addon">
		                						<span class="glyphicon glyphicon-calendar"></span>
		            						</span>
		            					</div> 
	        	...
	        	<div class="container">
					<div class="panel-title">
				   		<div class="row">
				            <div class="col-sm-12 col-md-6 col-md-offset-3">
				                <label>VENTAS</label>  
				                <input type="text" class="form-control requerido" id="f2p2a" name="f2p2a" placeholder="Comentarios"/>
			                </div>
			            </div>
					</div>		
	        	</div>
					...
					<div class="panel-title">
				   		<div class="row">
				            <div class="col-sm-12 col-md-6 col-md-offset-3">
				                ...
				                <input type="text" class="form-control requerido" id="f2p3a" name="f2p3a" placeholder="Comentarios"/>
			                </div>
			            </div>
					</div>		
	        	</div>
	        	...
	        	<div class="container">
					<div class="panel-title">
				   		<div class="row">
				            <div class="col-sm-12 col-md-6 col-md-offset-3">
				                <label>NOMINA</label> 
				                <input type="text" class="form-control requerido" id="f2p4a" name="f2p4a" placeholder="Comentarios"/>
			                </div>
			            </div>
					</div>		
	        	</div>
					...
					<div class="panel-title">
				   		<div class="row">
				            <div class="col-sm-12 col-md-6 col-md-offset-3">
				                ...
				                <input type="text" class="form-control requerido" id="f2p5a" name="f2p5a" placeholder="Comentarios"/>
			                </div>
			            </div>
					</div>		
	        	</div>
					...
					<div class="panel-title">
				   		<div class="row">
				            <div class="col-sm-12 col-md-6 col-md-offset-3">
				                ...
				                <input type="text" class="form-control requerido" id="f2p6a" name="f2p6a" placeholder="Comentarios"/>
			                </div>
			            </div>
					</div>		
	        	</div>
	...
	<div class="panel panel-default">
   	...
   	<script src="../../views/java_script/formulario_dos.js"></script>
