<div class="row">
	<div class="col-md-12 col-xs-12">
		...
		<button
				onclick="externo.guardar_detalles_pedido(<?php echo $objeto_json ?>)" 
		...
		<?php } else if($objeto['promocion'] == 1) { ?>
			...
			<button 
					onclick="$('#div_promocion').html(externo.htmlPromo)" 
					type="button" 
					style="background-color: #D6872D; color:white;"
					class="btn">
					<i class="fa fa-ban"></i> Cancelar
			...
			<button onclick="externo.area_inicio()" type="button" class="btn" style="background-color: #D6872D; color:white;">
				<i class="fa fa-ban"></i> Cancelar
			</button><?php
		} ?>
	</div>
				...
				<div class="row">
					...
					<div class="col-md-9" align="right">
						<button 
							class="btn" 
							style="background-color: #D6872D; color:white;"
							onclick="externo.reiniciar_opcionales({
									grupo: 1
								})">
						...
						foreach($value as $k => $v) { ?>
							...
							<div
								...
								<button
									...
									onclick="externo.seleccionar_opc({
