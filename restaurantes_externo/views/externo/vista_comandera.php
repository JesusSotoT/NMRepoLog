...
<div class="row"><!-- Departamentos, familias y lineas -->
	<div class="colo-md-4 col-xs-4">
		<div class="row">
			<div class="col-md-3 col-xs-3" style="float:right;">
				<button 
					onclick="externo.agregar_persona_comandera({
						num_personas: externo['datos_mesa_comanda']['num_personas'],
	...
	<div class="col-md-5 col-xs-5">
		<div class="btn-group" role="group" aria-label="...">
			...
			<button
				onclick="externo.listar_complementos({
					div: 'div_productos',
					comanda: externo['datos_mesa_comanda']['id_comanda'],
					pedido: externo['datos_mesa_comanda']['pedido_seleccionado']
				})"
				class="btn"
			...
			<button
				onclick="externo.listar_promociones({
					div: 'div_productos',
					tipo: 7,
					persona: externo.datos_mesa_comanda['persona_seleccionada'],
					comanda: externo['datos_mesa_comanda']['id_comanda']
	...
	<div class="col-md-3 col-xs-3"><!-- Buscador  -->
		<div class="input-group">
			<input onkeypress="if(((document.all) ? event.keyCode : event.which)==13) externo.buscar_productos({texto: $('#texto').val(), comanda: externo['datos_mesa_comanda']['id_comanda'], div:'div_productos'})" type="search" id="texto" class="form-control" placeholder="pasta, corte, desayuno, omelet, etc.">
				...
				<div class="row">
					<div class="col-md-12 col-xs-12" align="right">
						<button 
							...
							class="btn btn-lg" 
							style="background-color: #209775; color:white;"
							onclick="externo.guardar_combo({
									btn: 'btn_combos', 
									pedidos: externo.pedidos_seleccionados,
									datos_combo: externo.datos_combo,
									persona: externo['datos_mesa_comanda']['persona_seleccionada']
							})">
							<i class="fa fa-check"></i> Ok
						</button>
				...
				<div class="row">
					<div class="col-md-12 col-xs-12" align="right">
						<button 
							...
							class="btn btn-lg" 
							style="background-color: #209775; color:white;"
							onclick="externo.guardar_promocion({
									btn: 'btn_promociones', 
									pedidos: externo.pedidos_seleccionados,
									datos_promocion: externo.datos_promocion,
									persona: externo['datos_mesa_comanda']['persona_seleccionada']
							})">
							<i class="fa fa-check"></i> Ok
						</button>
...
<div class="col-md-6 col-xs-6 div_scroll_x" id="div_departamentos"><?php
	foreach($deparmentos['rows'] as $value){ ?>
		<button
			class="btn btn-lg btn-departamento"
			onclick="externo.listar_familias({
				departamento: <?php echo $value['idDep'] ?>,
