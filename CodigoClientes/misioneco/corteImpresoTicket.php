        ...
        <div class="row">
            ...
            <div class="col-sm-4" style="text-align:right;">
                ...
                <?php 
                    ...
                    echo number_format(abs($totalVentas),2); 
                ?>
            </div>
        </div>
        <div class="row" hidden>
...
<!--         <?php 
        ...
        <?php 
            ...
            $cantidadRetiro -= $totalCancelaciones;
        ?>
        <div class="row">
            <div class="col-sm-6">
                <span> - Retiros</span>
        ...
        $totalTarjetas += ($resumenCorte['amex'] + $resumenCorte['visa'] + $resumenCorte['mc']);
        ?>    
        <div class="row">
            <div class="col-sm-6">
                <hr>
...
<!-- ////////// -->
        ...
        <div class="row">
            <div class="col-sm-6">
                <span> * Retiro Corte </span>
            </div>
            <div class="col-sm-1">$</div>
            <div class="col-sm-4" style="text-align:right;">
                <?php $retiroCorte = ( $efectivo + $cantidadAbonoEfectivo - $cantidadRetiro -$totalCancelaciones ) ; ?>
                <?= number_format($retiroCorte, 2) ?>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-1">$</div>
            <div class="col-sm-4" style="text-align:right;">
                <?php $totalCorte = ( ($totalVentas - $efectivo) + $retiroCorte ) ; ?>
