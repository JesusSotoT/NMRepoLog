...
### BEGIN - SINCRONIZACION A INSTANCIAS ###
	...
	do
		...
		if [ -d $arg ] && [ $arg == "danielrosales" ] && [ $arg == "sistema" ] && [ $arg == "inmobiliariaarmeca" ] && [ $arg == "iafl" ] && [ $arg == "arcsanquintin" ] && [ $arg == "rogm" ] && [ $arg == "acas" ] && [ $arg == "orma" ] && [ $arg == "sseti" ] && [ $arg == "yare" ] && [ $arg == "ccpg" ] && [ $arg == "jissa" ] && [ $arg == "ccpcolima" ] && [ $arg == "mifarma_mgi" ] && [ $arg == "matte" ] && [ $arg == "prepa15sta" ] && [ $arg == "isojal15" ] && [ $arg == "despachodm" ] && [ $arg == "isojal11" ] && [ $arg == "isojal" ] 
		then
