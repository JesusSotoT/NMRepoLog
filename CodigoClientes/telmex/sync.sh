...
##Archivos cuando la carpeta existe.

arrFiles=(
webapp/modulos/xtructur/sql_jsasignacion.php
webapp/modulos/xtructur/sql_jsindicarpu.php
webapp/modulos/xtructur/sql_jspudestajos.php
webapp/modulos/xtructur/sql_jspusubcontratos.php
webapp/modulos/xtructur/sql_jsvisualizarpcontrol.php
webapp/modulos/appministra/models/reportes.php
webapp/modulos/appministra/controllers/reportes.php
webapp/modulos/mrp/antesprove.php
webapp/modulos/organizaciones/antes.php
webapp/modulos/pos/controllers/cliente.php
webapp/modulos/pos/js/cliente.js
webapp/modulos/pos/models/cliente.php
webapp/modulos/pos/views/cliente/clienteForm.php
)
#Cuando las carpetas son nuevas.
arrDirsRNew=(
)

#Cuando las carpetas son nuevas eliminar la ultima diagonal /.
...
### BEGIN - SINCRONIZACION A INSTANCIAS ###
	...
	for arg in *
	do
		if [ -d $arg ] && [ $arg != "_base" ] && [ $arg != "lantiguasssss" ] && [ $arg != "losarcos" ] && [ $arg != "muelle98" ] && [ $arg != "aepespecialistas" ] && [ $arg != "patriciag2" ] && [ $arg != "cdgrafael" ]
		then
