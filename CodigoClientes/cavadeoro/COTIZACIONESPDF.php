...
class CFDIPDF{
    ...
    function datosCFD($folioC,$fecha,$tipo,$moneda){
        ...
        <table border="0" cellpadding="1" cellspacing="1" width="100%">
            <tbody>
                <tr>
                    <td>Vencimiento <u>8 febrero 2009 </u></td>
                    <td style="text-align: right;">Capital $<u> 50,000.00</u></td>
                </tr>

                <tr>
                    <td>&nbsp;</td>
                    <td style="text-align: right;">Intereses $ <u>10,000.00</u></td>
                </tr>

                <tr>
                    <td>&nbsp;</td>
                    <td style="text-align: right;">Total $<u> 60,000.00</u></td>
                </tr>

                <tr><td colspan="2">Por este PAGAR&Eacute;, yo <u>Mar&iacute;a de los Angeles Ram&iacute;rez Torres</u> prometo incondicionalmente pagar a la orden de el<u> Sr. Mario P&eacute;rez Mar&iacute;n</u>, la cantidad de $ <u>50,000.00 </u>el d&iacute;a<u>&nbsp; 8</u> de <u>febrero </u>de <u>2009</u>. La suma que ampara este t&iacute;tulo causar&aacute; interes a raz&oacute;n de <u>10</u>% y a raz&oacute;n de <u>25</u> % anual en caso de mora.</td></tr><tr><td colspan="2" style="text-align: right;">M&eacute;xico, D.F. a <u>&nbsp;&nbsp; 2&nbsp;&nbsp; </u>de<u> octubre </u>de<u> 2008</u></td></tr><tr><td colspan="2" style="text-align: center;"><br /><u>Mar&iacute;a de los Angeles Ram&iacute;rez Torres</u><br />(Nombre y firma del Suscriptor)</td>
                </tr>
            </tbody>
        </table>*/
            ...
            $px=20;
                    ...
                    foreach($this->carray as $key=>$indiceKey){
                       ...
                       /* $strFileName=dirname(__FILE__)."/".date('Ymdhis').rand(1000, 9999)."-sello.txt";
                        ...
                        switch($plantilla){
                            case 0:
                            $content.='<tr><td style="font-size:10px;border-bottom:1px dashed '.$this->color.';border-right:1px dashed '.$this->color.';text-align:left">Total</td><td style="font-size:10px;border-bottom:1px dashed '.$this->color.';text-align:right">'.$this->total[1].' '.$this->datosCFD[3].'</td></tr></table></div><div style="margin-left:10px"><table><tr><td style="font-size:11px;border-bottom:1px dashed '.$this->color.';border-right:1px dashed '.$this->color.';padding-left:30px;padding-right:10px">TOTAL EN LETRA:</td><td style="font-size:10px;border-bottom:1px dashed '.$this->color.';padding-left:5px">'.$this->metodoPago[2].$this->datosCFD[3].'</td></tr></table></div><div style="font-weight:bold;font-size:11px;background:'.$this->color.';margin-top:10px;color:#000000;">Observaciones</div><div style="font-size:10px;border:1px solid '.$this->color.';padding:5px"><div style="width:381px;padding-top:-2px">'.wordwrap($this->observaciones,112,"</div><div style=\"width:380px;margin-top:3px\">",true).'</div></div><div>'.'<div> </div><div> </div><div style="font-weight:bold;font-size:13px;background:'.$this->color.';padding-right:10px">Pagar&eacute;</div><div style="font-size:11px;background:'.$this->color.';padding-right:10px; text-align:right;">'.$this->datosEmisor[5].', '.$this->datosEmisor[6].' a '.$this->datosCFD[1].' </div><div><table style="border:1px '.$this->color.';"><tr><td style="font-size:10px; text-align: right; width:750px"> Cantidad: <b>$ '.$this->total[1].' </b> </td></tr><tr> </tr> <tr> </tr><tr><td  style="font-size:10px; text-align: justify; width:750px"> '.wordwrap('Por este PAGAR&Eacute;, yo <b> '.$this->datosReceptor[0].' </b> prometo incondicionalmente pagar a la &oacute;rden de <b>'.$this->datosEmisor[0].'</b>, la cantidad de <b> $ '.$this->total[1].' ('.$this->metodoPago[2].' '.$this->datosCFD[3].')').'</b> </td></tr></table></div><div> </div> <div> </div> <div> </div><div style="font-size:13px; padding-right:10px; text-align: center"> <u> &nbsp; <b>'.$this->datosReceptor[0].'</b> &nbsp; </u> <br /> (Nombre y firma del Suscriptor) </div>'.'</div></body></html>';
                            break;

                            case 1:
                            $content.='<tr><td style="font-size:10px;border-bottom:1px dashed '.$this->color.';border-right:1px dashed '.$this->color.';text-align:left">Total</td><td style="font-size:10px;border-bottom:1px dashed '.$this->color.';text-align:right">'.$this->total[1].' '.$this->datosCFD[3].'</td></tr></table></div><div style="margin-left:10px"><table><tr><td style="font-size:11px;border-bottom:1px dashed '.$this->color.';border-right:1px dashed '.$this->color.';padding-left:30px;padding-right:10px">TOTAL EN LETRA:</td><td style="font-size:10px;border-bottom:1px dashed '.$this->color.';padding-left:5px">'.$this->metodoPago[2].'</td></tr></table></div><div style="font-weight:bold;font-size:11px;background:'.$this->color.';margin-top:10px">Observaciones</div><div style="font-size:10px;border:1px solid '.$this->color.';padding:5px"><div style="width:381px;padding-top:-2px">'.wordwrap($this->observaciones,112,"</div><div style=\"width:380px;margin-top:3px\">",true).'</div></div><div style="margin-top:10px"><table><tr><td style="font-weight:bold;font-size:11px;background:'.$this->color.';width:392px">Cadena original del complemento de certificacion del SAT</td><td style="font-weight:bold;font-size:11px;background:'.$this->color.';width:352px">Codigo original del complemento de certificacion del SAT</td></tr></table></div><div><table><tr><td style="font-size:8px;width:392px"><div><div>'.wordwrap($this->selloDigitales[0],58,"</div><div>",true).'</div></div><div style="font-weight:bold;font-size:11px;background:'.$this->color.';width:387px;margin-top:10px">Sello digital del emisor</div><div style="width:387px"><div>'.wordwrap($this->selloDigitales[1],58,"</div><div>",true).'</div></div><div style="font-weight:bold;font-size:11px;background:'.$this->color.';width:387px;margin-top:10px">Sello digital del SAT</div><div><div>'.wordwrap($this->selloDigitales[2],58,"</div><div>",true).'</div></div></td><td style="font-size:8px;width:352px;border-left:1px dashed '.$this->color.'"><img style="-webkit-user-select:none" src=""></td></tr></table></div><div style="font-size:8px;padding-left:100px"><table><tr><td>ESTE DOCUMENTO ES UNA REPRESENTACION IMPRESA DE UN CFDI</td><td style="padding-left:50px;border-collapse:collapse">Este Documento Fue Generado Utilizando Herramientas De Netwarmonitor</td></tr></table></div><div>Este Documento de creo con herramientas de Netwarmonitor</div> <div>'.'<div> </div><div> </div><div style="font-weight:bold;font-size:13px;background:'.$this->color.';padding-right:10px">Pagar&eacute;</div><div style="font-size:11px;background:'.$this->color.';padding-right:10px; text-align:right;">'.$this->datosEmisor[5].', '.$this->datosEmisor[6].' a '.$this->datosCFD[1].' </div><div><table style="border:1px '.$this->color.';"><tr><td style="font-size:10px; text-align: right; width:750px"> Cantidad: <b>$ '.$this->total[1].' </b> </td></tr><tr> </tr> <tr> </tr><tr><td  style="font-size:10px; text-align: justify; width:750px"> '.wordwrap('Por este PAGAR&Eacute;, yo <b> '.$this->datosReceptor[0].' </b> prometo incondicionalmente pagar a la &oacute;rden de <b>'.$this->datosEmisor[0].'</b>, la cantidad de <b> $ '.$this->total[1].' ('.$this->metodoPago[2].' '.$this->datosCFD[3].')').'</b> </td></tr></table></div><div> </div> <div> </div> <div> </div><div style="font-size:13px; padding-right:10px; text-align: center"> <u> &nbsp; <b>'.$this->datosReceptor[0].'</b> &nbsp; </u> <br /> (Nombre y firma del Suscriptor) </div>'.'</div></body></html>';
                            break;
                        }
