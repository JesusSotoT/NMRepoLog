...
CREATE TABLE IF NOT EXISTS `app_configuracion` (
  ...
  `not_cortes` varchar(500) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `app_inventario_movimientos` (
  ...
  KEY `id_pedimento_idx` (`id_pedimento`),
  KEY `id_lote_idx` (`id_lote`),
  KEY `id_almacen_origen_idx` (`id_almacen_origen`),
  KEY `id_almacen_destino_idx` (`id_almacen_destino`),
  KEY `tipo_traspaso_idx` (`tipo_traspaso`)
) ENGINE=InnoDB AUTO_INCREMENT=768 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

CREATE TABLE IF NOT EXISTS `app_inventario_traslados` (
...
CREATE TABLE IF NOT EXISTS `app_inventario_traslados_movimientos` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
VALUES
  ...
  (2, 'Compras', 2, 0, 'Poliza de Compras', 1, 1, 1),
...
DROP TABLE app_tpl_polizas_mov;
...
ADD COLUMN  `idVendedor` int(11) DEFAULT NULL AFTER numero_cuenta_banco;
...
CREATE TABLE IF NOT EXISTS app_recepcion_xml(
  id int(11) NOT NULL AUTO_INCREMENT,
  id_oc int(11) DEFAULT NULL,
  fecha_factura datetime DEFAULT NULL,
  imp_factura double DEFAULT NULL,
...
ALTER TABLE app_requisiciones ADD id_usuario int(11);
ALTER TABLE app_requisiciones_venta ADD id_usuario int(11);
ALTER TABLE app_ocompra ADD id_usuario int(11);
ALTER TABLE app_oventa ADD id_usuario int(11);
ALTER TABLE app_recepcion ADD id_usuario int(11);

ALTER TABLE pvt_configura_facturacion ADD lugar_exp varchar(100) DEFAULT 'Mexico';


ALTER TABLE app_requisiciones ADD fecha_creacion DATETIME;
ALTER TABLE app_ocompra ADD fecha_creacion DATETIME;
ALTER TABLE app_oventa ADD fecha_creacion DATETIME;
ALTER TABLE app_requisiciones_venta ADD fecha_creacion DATETIME;

ALTER TABLE app_respuestaFacturacion ADD fecha_cancelacion DATETIME;
ALTER TABLE app_respuestaFacturacion ADD cancelre int(11) DEFAULT 0;

/*--------- ALter table cliente -------------------------*/

 ALTER TABLE `comun_cliente` ADD `idVendedor` INT(11)  NULL  DEFAULT NULL  AFTER `numero_cuenta_banco`;
