...
class  Cpdf {
    ...
    if  (!isset($this->fonts[$fontName])) {
      ...
      if  (isset($this->fonts[$fontName])) {
        ...
        if  (substr($fontName, -4) ==  '.afm' &&  strlen($fbtype)) {
		  ...
		  //1-$tmp =  get_magic_quotes_runtime(); OMAR 2010-10-30

          //set_magic_quotes_runtime(0); OMAR 2010-10-30

          $data =  file_get_contents($fbfile);

          //set_magic_quotes_runtime($tmp); OMAR 2010-10-30
  ...
  function  addPngFromFile($file, $x, $y, $w =  0, $h =  0) {
    ...
    //$tmp =  get_magic_quotes_runtime(); OMAR 2010-10-30
  ...
  function  addImage(&$img, $x, $y, $w =  0, $h =  0, $quality =  75) {
    ...
    //$fp = fopen($tmpName,'rb'); no se esta la comente yo OMAR 2010-10-30
