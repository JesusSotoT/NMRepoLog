...
<div class="container">
	<div class="row">
      ...
      <section style="min-height: 550px; background: transparent url('../../img/clientes.png') no-repeat scroll center center / cover ;">
  			<div class="row">
        ...
        <div class="row" style="margin-top: 5em !important;">
          <div class="col-md-2 col-sm-2 col-xs-2">
            <img src="../../img/icono_clientes.png" style="width: 6em; margin-left: 1.2em;">
          </div>
          <div class="col-md-10 col-sm-10 col-xs-10">
            <label class="smart" style="color: white; font-weight: 200; font-size: 4em; letter-spacing: 0.03em;">¡Tus <strong>clientes!</strong></label>
          </div>
        </div>
        <?php
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-md-12">
            <img src='../../img/xls_icon.gif'> <a href='plantilla.xls'>Descarga la plantilla para los clientes</a>
            <hr/>
