				...
				else
				{
					...
					//  Barre sobre cada fila en turno
						...
						{ 
							...
							if(preg_match($soloNumero, $rowData[0][7])){
								$caracterInvalido=true;
								$errores.= "<br>[Fila: ".$row."] [Estado: ".$rowData[0][7]."]";
							}
							if(preg_match($soloNumero, $rowData[0][8])){
								$caracterInvalido=true;
								$errores.= "<br>[Fila: ".$row."] [Municipio: ".$rowData[0][8]."]";
							}
							if(preg_match($soloNumeroPunto, $rowData[0][12])){
								$caracterInvalido=true;
								$errores.= "<br>[Fila: ".$row."] [Límite/cred.: ".$rowData[0][12]."]";
							}
							if(preg_match($soloNumero, $rowData[0][13])){
								$caracterInvalido=true;
								$errores.= "<br>[Fila: ".$row."] [Días/cred.: ".$rowData[0][13]."]";
							}

							if(preg_match($soloNumero, $rowData[0][16])){
								$caracterInvalido=true;
								$errores.= "<br>[Fila: ".$row."] [id_clasif: ".$rowData[0][16]."]";
							}
								...
								<div class="table-responsive">
									<table cellpadding='0' cellspacing='0' width='100%' style='min-width: 100%; font-size: 11px; overflow: auto; max-height: 350px; border: 1px solid #98ac31; padding: 10px;'>
										<tr>
											...
											<th class='nmcatalogbusquedatit' width=15% style='border-bottom: 1px solid #98ac31; '>Exterior</th>
											<th class='nmcatalogbusquedatit' width=15% style='border-bottom: 1px solid #98ac31; '>Interior</th>
											...
											<th class='nmcatalogbusquedatit' width=5%  style='border-bottom: 1px solid #98ac31;  '>Pais</th>
											...
											<th class='nmcatalogbusquedatit' width=5%  style='border-bottom: 1px solid #98ac31;  '>Ciudad</th>
											...
											<th class='nmcatalogbusquedatit' width=10% style='border-bottom: 1px solid #98ac31;  '>Código</th>
											<th class='nmcatalogbusquedatit' width=10% style='border-bottom: 1px solid #98ac31;  '>Id Clasificación</th>
											<th class='nmcatalogbusquedatit' width=10% style='border-bottom: 1px solid #98ac31;  '>Id lista precios</th>
