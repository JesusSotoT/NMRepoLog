		...
		<script>
			...
			$(document).ready(function() {
				...
				if ( data !== "" )
				{
					...
					{
						line  = "<tr class='nmsubtitle'>";
						line += "	<td colspan='17' style='text-align:center;color:red; font-weight:bold;'>No payments registered for the period.";
						line += "	</td>";
						line += "</tr>";
						$("#pagos_div tbody").append( line );
					}
					...
					{
						line  = "<tr class='nmsubtitle'>";
						line += "	<td colspan='7' style='text-align:center;color:red; font-weight:bold;'>No sold items for the period.";
						line += "	</td>";
						line += "</tr>";
						$("#productos_div tbody").append( line );
					}
		...
		<div class="container" id='formulario'>
			...
			<section>
	        	<div class="row">
	        		...
	        		<div class="col-sm-3">
	        			<button class="btn btn-success btnMenu col-md-6 throwback">Back to listing</button>
	        		</div>
	        	</div>
	        </section>
		        				...
		        				<table id='productos_div' class="busqueda table">
									<thead>
										<tr class="tit_tabla_buscar">
											...
											<th class="nmcatalogbusquedatit">Discount</th>
											<th class="nmcatalogbusquedatit">Tax</th>
	        					...
	        					<table class="busqueda table" id="cxc_div">
									<thead>
										<tr class="tit_tabla_buscar">
											...
											<th class="nmcatalogbusquedatit">Deposite date</th>
											<th class="nmcatalogbusquedatit">Customer</th>
