...
$consulta="SELECT  	
	...
	FROM mrp_producto p inner Join mrp_linea l on p.idLinea=l.idLin inner Join mrp_familia f on f.idFam=l.idFam inner Join mrp_departamento d on d.idDep=f.idDep left Join mrp_color c on c.idCol=p.color left Join mrp_talla t on p.talla=t.idTal where estatus=1 and ".$filtro." order by p.nombre asc";
