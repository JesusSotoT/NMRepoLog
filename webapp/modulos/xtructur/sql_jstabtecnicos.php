...
if(isset($oper) && $oper=='add'){
	...
	$mysqli->query("INSERT INTO constru_categoria (id_familia,clave_cat,categoria,sal_mensual,dias) VALUES ('$id_familia', '$clave_cat', '$categoria', '$sal_mensual','$dias');");
...
if(isset($oper) && $oper=='edit'){
	...
	$mysqli->query("UPDATE constru_categoria SET id_familia='$id_familia', categoria='$categoria', sal_mensual='$sal_mensual' , dias='$dias' WHERE id='$id';");
	exit();
}
...
while($row = $result->fetch_array()) {
    ...
    $responce->rows[$i]['cell']=array($row['familia'],$row['clave_cat'],$row['categoria'],$row['sal_mensual'],$row['dias'],'');
    $i++;
}        
