...
<div class="row" style="margin:0px 0 10px 0;">Ver gantt:
<button class="btn btn-primary btn-xs" onclick="zoom_tasks('dia');"> Dia</button> 
<button class="btn btn-primary btn-xs" onclick="zoom_tasks('quincenal');"> Quincenal</button>
<button class="btn btn-primary btn-xs" onclick="zoom_tasks('mensual');"> Mensual</button>
<button class="btn btn-primary btn-xs" onclick="zoom_tasks('trimestral');"> Trimestral</button>
<button class="btn btn-primary btn-xs" onclick="zoom_tasks('semestral');"> Semestral</button>
</div>
...
function zoom_tasks(node){
	//gantt.init("gantt_here");
//“quincenal”, “mensual”, “trimestral” y “semestral”.
/*
	gantt.config.scale_unit = "month";
	gantt.config.date_scale = "%F, %Y";
gantt.config.subscales = [
