...
table tr:hover td {
  ...
  background: -moz-linear-gradient(top,  #f2f2f2,  #f0f0f0);  
    ...
    function desplegar(id){
        ...
        success: function(obj){
          ...
          if(obj.coms!=0){
            ...
            $.each(obj.coms, function( key, value ) {
              v+='<div id="area_'+id+'_com" style="float:left; width:700px;margin:5px 0 5px 0;">\
              <textarea disabled align="center" id="val_'+id+'_area" style="width:660px;border: 1px none #cecece;min-height:50px;margin-left:20px; resize: none; color:#color:#666;">'+value.comentario+'</textarea>\
              </div>';
            });
          }else{
            v='';
            v+='<div id="area_'+id+'_com" style="float:left; width:700px;margin:5px 0 5px 0px;"></div>';
          }
          $('#load_'+id+'_load').html('\
      ...
      <div id="cont__resp" style="float:left; width:700px;background-color: #fafafa;">\
        <div id="resp__desc" style="float:left; width:700px;margin-top:5px;">\
          <div id="txt__area" style="float:left; width:700px; background-color:#fafafa;">\
    ...
    function respuesta_com(id){
      ...
      if(titulo==''){
        alert('Tienes que agregar un titulo');
        return false;
      }
      if(contenido==''){
      ...
      $.ajax({
        ...
        success: function(obj){
          ...
          src = $('#tb1638-u iframe', window.parent.document).attr('src');
  ...
  <ul>
    ...
    <li><a href="#tabs-1">Articulos</a></li>
    <li><a href="#tabs-2">Crear articulo nuevo</a></li>
