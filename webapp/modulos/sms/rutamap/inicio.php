<html>
    ...
    <body onload="start()">
      ...
      <div><select id="oferta" align="center" onchange="oferta()" align="center" style="  cursor:pointer; margin-top:5px; border:0px; background-color:#91C313; font-size:12px; color:#FFFFFF;">
...
$(document).ready(function(){
  ...
  $(".generarOrden").click(function(){
    ...
    $.ajax({
      data:{idruta:$("#ruta").val().split("->")[0]},
          url:'generarOrden.php',
          type: 'POST',
          dataType: "json",
...
//         
    ...
    function(respuesta) {
      ...
      $.post('geolo.php',{idruta:idruta[0],lon:lon,lat:lat,opt:opt,origen:origen},
      function(respues) {
