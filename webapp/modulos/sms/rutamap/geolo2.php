<?php
	...
	e.estado,m.municipio from sms_oferta_cliente oc,comun_cliente cc, estados e, municipios m
	where oc.idOferta=".$idruta." and cc.id=oc.idCliente and e.idestado=cc.idEstado and m.idmunicipio=cc.idMunicipio and oc.contesto=1");
