...
<div id="contenido" class="col-xs-12 container-fluid">
            ...
            <div class="panel-body">
                ...
                <div class="col-xs-12">
                    <div class="col-sm-3 col-xs-6">
                        ...
                        <button style="margin-top:1em; margin-bottom:1em;" type="button" class="btn btn-success" onclick="addSerie();">Agregar numero de serie</button>
                    </div>
                </div>    
                <div class="col-xs-12">
   ...
   <input type="button" value="Regresar" onclick="goBack();" class="btn btn-danger btnMenu">
</div>   
</body>
</html>