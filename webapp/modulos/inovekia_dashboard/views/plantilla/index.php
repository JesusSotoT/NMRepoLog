...
<html lang="en">
    ...
    <body>
        ...
        <div class="row">
            <div class="col-md-12">
                <form id="frm">
                    <label>Seleccionar plantilla relacional:</label>
                    <input type="file" id="excel" name="excel" class="archivo imagen requerido" accept="application/vnd.ms-excel">
                    <button id="btn_guardar" type="button" class="btn btn-primary">Procesar información</button>
                    <div class="row">
                    </div>
                    <div class="row">
                    <a href="views/plantilla/PlantillaRelacional.xls">Descargar plantilla relacional</a>
                    <div class="row">
                    </div>
                    <div class="row">
                    </div>
                    <label>Seleccionar plantilla de usuarios:</label>
                    <input type="file" id="excel_usuarios" name="excel_usuarios" class="archivo imagen requerido" accept="application/vnd.ms-excel">
                    <button id="btn_guardar_usuarios" type="button" class="btn btn-primary">Procesar información</button>
                    <div class="row">
                    </div>
                    <div class="row">
                    <a href="views/plantilla/PlantillaUsuario.xls">Descargar plantilla usuarios</a>
                </form>
            </div>
        </div>
