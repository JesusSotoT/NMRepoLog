...
<html lang="en">
    ...
    <body>
        ...
        <div id="listado" class="content-fluid">
            ...
            <div class="row item">
                <div class="col-md-4 col-md-offset-1 bg-gray text-center">
                    <label class="separador">Empresario</label>
                </div>
                <div class="col-md-5 text-center">
                    <label class="bg-gray separador text-center porcentaje">Cursos</label>
        ...
        <script src="js/reporte/cursos/empresario.js"></script>
