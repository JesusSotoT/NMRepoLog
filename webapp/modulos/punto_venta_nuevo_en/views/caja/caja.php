...
<head>
    ...
    <input type=hidden id=timp value=0>
...
<body>
            ...
            <form>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Item:</label>
                            <input type="text" class="typeahead form-control " id="search-producto" placeholder="Type item code or item description" data-provide="typeahead" onkeypress="caja.busquedaXcodigo(event)">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Customer:</label>
                            <input type="text" class="typeahead form-control " id="cliente-caja" placeholder="General public" data-provide="typeahead">
                        </div>
                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <label>Current payed amount:</label>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <?php
                                ...
                                foreach ($formasDePago as $key => $value) {
                                    echo '<option value="'.$value['idFormapago'].'">'.utf8_decode($value['name']).'</option>';
                                }
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" onkeypress="return caja.isNumberKey(event)" id="txtCantidadPago" style="width: 100% !important;" placeholder="Amount" value="">
                        </div>
                        <div class="col-md-4">
                            <label>&nbsp;</label>
                            <button class="btn btn-primary btnMenu" id="btnAgregarPago">Add payment</button>
                        </div>
                    </div>
                    ...
                    <section>
                        <div class="row">
                            <div class="col-md-6">
                                <label>Pending amount due:</label>
                ...
                <div class="modal-footer">
                    <div class="row">
                        <div class="col-md-3">
                            <button onclick="javascript:caja.pagar();" type="button" class="btn btn-success btnMenu">Pay now</button>
                        </div>
                        <div class="col-md-3">
                            <button onclick="javascript:$('#modalPago').modal('hide'); caja.suspender();" type="button" class="btn btn-warning btnMenu">Suspend</button>
                        </div>
                        <div class="col-md-3">
                            <button onclick="javascript:$('#modalPago').modal('hide');" type="button" class="btn btn-danger btnMenu">Exit</button>
                        </div>
                        <div class="col-md-3">
                            <button onclick="javascript:caja.cancelarCaja(true); $('#modalPago').modal('hide');" type="button" class="btn btn-danger btnMenu">Cancel</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-footer">
                    <div class="row">
                        <div class="col-md-6 col-md-offset-6">
                            ...
                            <button class="btn btn-danger btnMenu" onclick="limpiaFrame();">Exit</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div id='inicio_caja' class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">POS Set up</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <label>Current POS balance:</label>
                            <label id="saldocaja"></label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <label>POS Set up amount:</label>
                ...
                <div class="modal-footer">
                    <div class="row">
                        <div class="col-md-6">
                            <button class="btn btn-success btnMenu" onclick="javascript:caja.cajaIniciar();">Set up</button>
                        </div>
                        <div class="col-md-6">
                            <button class="btn btn-danger btnMenu" onclick="javascript:caja.cajaCancelar();">Cancel</button>
                        </div>
                    </div>
                </div>
            </div>
