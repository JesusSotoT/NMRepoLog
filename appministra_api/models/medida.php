<?php
    ...
    class MedidaModel extends Connectionapi
    {
        ...
        public function obtenerMedida($filtros, $parametros){
            try{
                $select = "SELECT * FROM app_unidades_medida WHERE ". $filtros ." AND activo = 1;";
